  ...
  <div class="container-fluid">
    ...
    <div class="mx-4 overflow-hidden card card-body blur shadow-blur mt-n6">
      <div class="row gx-4">
        ...
        <div class="col-auto my-auto">
          <vsud-badge :color="this.$route.query.managerStatus === 'In-Office' ? 'success' : 'secondary'"
            variant="gradient" size="sm" class="mx-auto">
            ...
            <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="first-tab" data-bs-toggle="tab" data-bs-target="#first"
                  ...
                  <p class="text-sm">View WFH schedule of employees under <u>{{ managerName }}</u>&nbsp;</p>
                </button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="second-tab" data-bs-toggle="tab" data-bs-target="#second" type="button"
                  ...
                  <p class="text-sm">View Overall WFH schedule of <u>{{ managerName }}</u>'s Team</p>
                </button>
              </li>
            </ul>
            <div class="tab-content p-3">
              <div class="tab-pane fade show active" id="first" role="tabpanel" aria-labelledby="first-tab"
                v-if="role == 2 || selectedDate != ''">
              ...
              <div class="tab-pane fade" id="second" role="tabpanel" aria-labelledby="second-tab">
                <smart-scheduler id="schedulerhro3" disableEventMenu disableContextMenu hideNonworkingWeekdays
...
export default {
  ...
  methods: {
    ...
    async fetchEmployeeData2() {
      ...
      try {
        ...
        console.log("Schedule displayed for staff: ", this.managerId);
    ...
    initializeScheduler(events, minStartDate, maxEndDate, restrictedDatesArray) {
      ...
      const schedulerhro3 = document.getElementById("schedulerhro3");

      if (!schedulerhro3.hasListener) {
        schedulerhro3.addEventListener("itemClick", function (event) {
          let queryParams = {
            managerid: mgrID,
            managerName: mgrName,
        ...
        schedulerhro3.hasListener = "true";
      }
    },
  ...
  mounted() {
    ...
    this.selectedSlot = this.$route.query.selectedSlot;
