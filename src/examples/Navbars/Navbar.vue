    ...
    <div class="px-3 py-1 container-fluid">
      ...
      <div id="navbar" class="mt-2 collapse navbar-collapse mt-sm-0 me-md-0 me-sm-4"
        ...
        <div class="pe-md-3 d-flex align-items-center" :class="$store.state.isRTL ? 'me-md-auto' : 'ms-md-auto'">
          ...
          <div class="pe-md-3 d-flex align-items-center" :class="$store.state.isRTL ? 'me-md-auto' : 'ms-md-auto'">
            <span :class="textWhite ? textWhite : 'text-body'">You're logged in as <b>{{ staff_position}}</b>, <b> {{ staff_id }}</b></span>
          </div>
        </div>
        <ul class="navbar-nav justify-content-end">
          <li class="nav-item d-flex align-items-center">
            ...
            >
              <i class="fa fa-user pe-2" :class="$store.state.isRTL ? 'ms-sm-2' : 'me-sm-1'"></i>
...
export default {
  ...
  data() {
    return {
      ...
      staff_position: localStorage.getItem("position"),
    };
  },
  computed: {
    currentRouteName() {
